...
if (!($_SESSION["client"]->verifyKeepLogged($_COOKIE['logged_in_flag'])) && !isset($_SESSION["client"]) ) {
            ...
            $(document).ready(function (e) {
                $("#loader").load("datareceiver.php", function (txt, stat) {
                    if (stat === 'success') {
                        ...
                        var min = new Date('<?php echo $crton->format('d M, Y'); ?>');
            ...
            <div id="data">
                <div id="datainner">
                    ...
                    <div id="datepickercontainer">
                        <input id="datepicker" type="text" value="<?php echo $today->format("d M, Y"); ?>"></input>
                    </div>
                </div>
            </div>
        </div>
